...
<body>
    <div class="login-container">
        <div class="login-header">
            ...
            <span class="badge"><i class="fas fa-hospital"></i> Facility Dashboard Access</span>
        </div>
        ...
        <div class="login-body">
            ...
            <a href="../investor/login.php" class="btn btn-outline">
